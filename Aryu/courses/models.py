...
class Course(models.Model):
    ...
    syllabus_title = models.CharField(max_length=255, null=True, blank=True)
    syllabus_thumbnail = models.ImageField(upload_to="course/syllabus_thumbnails/", null=True, blank=True)
