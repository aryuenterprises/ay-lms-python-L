...
urlpatterns = [
   ...
   path('student-usertype/',StudentusertypeViewSet.as_view({'get':'get','post':'post'})),
   ...
   path('certificates/student-status/<str:student_id>', CertificateViewSet.as_view({'get': 'student_certificate_status'})),
   path('certificates/student-status', CertificateViewSet.as_view({'get': 'student_certificate_status'})),
   path('student-certificate-status/<str:student_id>', CertificateViewSet.as_view({'get': 'student_certificate_status'})),
   path('student-certificate-status', CertificateViewSet.as_view({'get': 'student_certificate_status'})),
   ...
   path('trainer_attendance/<str:employee_id>/full_logs/', TrainerAttendanceViewSet.as_view({'get': 'full_logs'})),
   path('trainer/<str:employee_id>/full_logs', TrainerAttendanceViewSet.as_view({'get': 'full_logs'})),
   path('trainers/<str:employee_id>/full_logs', TrainerAttendanceViewSet.as_view({'get': 'full_logs'})),
