...
<table width="650" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:650px;background:#ffffff;border-radius:14px;overflow:hidden;border:1px solid #e5e7eb;">
    <tr>
        <td align="center" style="background:linear-gradient(135deg,#200A38,#430080);padding:35px 25px;">
            <img src="https://portal.aryuacademy.com/api/media/logos/email_logo.png" alt="Aryu Academy Private Limited" style="width:320px;max-width:90%;height:auto;display:block;margin:0 auto;object-fit:contain;" />
            <p style="margin:10px 0 0 0;color:#d8c9ff;font-size:14px;line-height:22px;">Invoice & Payment Confirmation</p>
        </td>
    </tr>
    <tr>
